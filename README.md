...
For this project, Muaziz Khan & George Naylor will be the stakeholders.
...
1. Download the CSVs within the [Datasets](https://github.com/Muaziz64/HR-analytics-Project--/tree/DATASET) folder into your directory
...
3. Create tables within your newly created database using the [SQL](https://github.com/Muaziz64/HR-analytics-Project--/blob/main/HR_Analytics%20(1).sql) file
...
The data dictionary for the tables within SQL can be found [here](https://github.com/Muaziz64/HR-analytics-Project--/blob/main/data_dictionary.xlsx).
...
### Data Science
A machine learning model that predicts the target, with a report of the model's performance
